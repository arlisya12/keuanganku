            ...
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <button class="btn btn-warning btn-sm pull-right" onclick="laporan()" style="margin-right: 5px;">Laporan Barang Masuk</button>
                    </div>
                </div>
      ...
      <div class="modal-body">
        <form class="form-horizontal form-material" id="form">
            <div class="form-group">
                <label class="col-md-12">Nama Barang Masuk</label>
                <div class="col-md-12">
                     <input type="hidden" id="id" name="id"/> 
                    <input type="text" name="nama" id="nama" placeholder="Nama Barang" class="form-control form-control-line">
