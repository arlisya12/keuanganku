...
<head>
    ...
    <!-- color CSS -->
    <link href="<?php echo base_url ?>assets/pixeladmin-lite/html/css/colors/green-dark.css" id="theme" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                <div class="top-left-part"><a class="logo" href="<?= base_url ?>"><b><img src="<?php echo base_url ?>assets\pixeladmin-lite\plugins\images\image\logo.png" alt="home" /></b><span class="hidden-xs"><img src="<?php echo base_url ?>assets\pixeladmin-lite\plugins\images\image\1 (1).png" alt="home" /></span></a></div>
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic" href="#"> <img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/users/pp.png" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?= $_SESSION['user'] ?></b> </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#dana_masuk" id="kas_masuk" class="waves-effect"><i class="fa fa-bank fa-fw" aria-hidden="true"></i><span class="hide-menu">Barang Masuk</span></a>
                    </li>
                    <li>
                        <a href="#kategori_pengeluaran" id="kategori_pengeluaran" class="waves-effect"><i class="fa fa-th-large fa-fw" aria-hidden="true"></i><span class="hide-menu">Kategori</span></a>
                    </li>
                    <li>
                        <a href="#pengeluaran" id="pengeluaran" class="waves-effect"><i class="fa fa-shopping-bag fa-fw" aria-hidden="true"></i><span class="hide-menu">Barang Keluar</span></a>
                    </li>
                    <li>
                        <a href="#catatan" id="catatan" class="waves-effect"><i class="fa fa-sticky-note fa-fw" aria-hidden="true"></i><span class="hide-menu">Catatan</span></a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> <?php echo date('Y'); ?> &copy; KeUanganKu By Mahasiswa H0re </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    $(document).ready(function() {
        ...
        $.toast({
            heading: 'Selamat Datang di KeUanganKu',
            text: 'Aplikasi pengelola Kas Keuangan by Mahasiswa H0re.',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3500,
      ...
      $("#catatan").click(function(){
        $("#kontenku").load("<?php echo base_url ?>page/catatan.php");
      });
    </script>
