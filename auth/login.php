...
body {
    ...
    background-image: url(../assets/pyggyyy.png);
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<form id="login-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" role="form" style="display: block;">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Lets Counting!">
											</div>
										</div>
									</div>
									...
									<div class="credit" >
									 <p><center>&copy; KeUanganKu By Mahasiswa H0re</center></p>
									 </div>
							</div>
						</div>
					</div>
